...
`docker run --name training-service --network training-network -p 8080:8080 -e DBMS_CONNECTION=jdbc:mysql://mysql:3306/project_sem4 nguyenduyhoang03/training-service:0.1.1`
